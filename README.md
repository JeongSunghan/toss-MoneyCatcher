...
네온 아케이드 스타일의 머니 캐칭 게임입니다. 떨어지는 돈을 휙득하여 부와 명예를 휙득하세요!
...
### 게임 방법
- **조작**: 좌우 스와이프 또는 방향키로 캐릭터 이동
- **목표**: 돈을 모아서 높은 금액을 유지하세요.
...
# 이용한 AI
- Perplexity : 아이디어 구상 및 기획, 에셋 검색 활용
- Claude : 구체적인 기획 방안 작성 및 피드백 내용 정리
- Chat GPT 5.1 / Gemini : 기본적인 코딩
