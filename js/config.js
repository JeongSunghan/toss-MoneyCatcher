...
(() => {
  ...
  Game.config = {
    ...
    LEVEL_SCORE_THRESHOLDS: [
      0,           // 레벨 1: 0원 (시작)
      15000,       // 레벨 2: 1.5만원
      50000,      // 레벨 3: 5 만원 (+3.5만원)
      150000,      // 레벨 4: 20만원 (+10만원)
      350000,      // 레벨 5: 35만원 (+15만원)
      600000,      // 레벨 6: 60만원 (+25만원)
      1000000,     // 레벨 7: 100만원 (+50만원)
      1500000,     // 레벨 8: 150만원 (+50만원)
      2500000,     // 레벨 9: 250만원 (+100만원)
      4000000,     // 레벨 10: 400만원 (+150만원)
    ],
